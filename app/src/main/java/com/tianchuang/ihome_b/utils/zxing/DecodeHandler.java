...
final class DecodeHandler extends Handler {
    ...
    private static final String TAG = com.tianchuang.ihome_b.utils.zxing.DecodeHandler.class.getSimpleName();

    private final ScanCodeFragment fragment;
    private final MultiFormatReader multiFormatReader;

    DecodeHandler(ScanCodeFragment fragment, Hashtable<DecodeHintType, Object> hints) {
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        if (rawResult != null) {
            ...
            bundle.putParcelable(com.tianchuang.ihome_b.utils.zxing.DecodeThread.BARCODE_BITMAP, source.renderCroppedGreyscaleBitmap());
