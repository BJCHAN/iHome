...
public class MaterialDialogsUtil {
     ...
     * @param negativeTextRes 取消按钮文本
     */
    public MaterialDialog.Builder getNoTitleBuilder(String content, String positiveTextRes, String negativeTextRes) {
        builder = new MaterialDialog.Builder(mContext).content(content).positiveText(positiveTextRes)
                .negativeText(negativeTextRes);
        return builder;
    }
