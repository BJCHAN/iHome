 ...
 */
public class TaskBuildingAdapter extends BaseQuickAdapter<TaskBuildingListBean, BaseViewHolder> {


    public TaskBuildingAdapter(List<TaskBuildingListBean> data) {
        super(R.layout.task_input_select_area_item_holder, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, TaskBuildingListBean item) {
