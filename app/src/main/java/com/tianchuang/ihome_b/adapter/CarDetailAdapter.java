...
public class CarDetailAdapter extends BaseQuickAdapter<EquipmentDetailBean.FieldDataListBean,BaseViewHolder> {
    public CarDetailAdapter(List<EquipmentDetailBean.FieldDataListBean> data) {
