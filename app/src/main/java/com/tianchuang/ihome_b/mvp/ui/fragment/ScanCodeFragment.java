...
import com.tianchuang.ihome_b.utils.zxing.ScanCodeActivityHandler;
...
public class ScanCodeFragment extends Fragment implements SurfaceHolder.Callback {
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		...
		if (view == null) {
			view = inflater.inflate(R.layout.fragment_scan_code, null);
		}
	...
	private void initCamera(SurfaceHolder surfaceHolder) {
		...
		if (handler == null) {
			handler = new ScanCodeActivityHandler(this, decodeFormats, characterSet, viewfinderView);
		}
	}
